...
#SBATCH -J inr-lichess-2x-rep
#SBATCH --array=0-7
#SBATCH -o /ocean/projects/cis260099p/akang3/INR/outputs/slurm/lichess-2x-rep-%A_%a.out
...
EXPS=(conflation generalization)
...
RUN_NAME="lichess_full_2Xepisode__${MODEL}__${EXP}__s0"

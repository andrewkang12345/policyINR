...
OUT_ROOT="${OUT_ROOT:-outputs/droid_lowdim_full_shards707of2048_p345_balanced_min300_remove_hk300_suite_20260503}"
SEEDS="${SEEDS:-0,1}"
EPOCHS="${EPOCHS:-30}"
WORKERS="${WORKERS:-0}"
...
CUDA_VISIBLE_DEVICES="${FAST_VISIBLE:-0,1,2,3}" python scripts/multi_gpu_launch.py \
  ...
  --seeds "${SEEDS}" \
  --out-root "${OUT_ROOT}" \
  --datasets "droid_lowdim_full_balanced_min300_remove" \
